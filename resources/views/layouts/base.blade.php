...
<head>
    ...
    <title>RMC - Project Management </title>
...
<body>
            ...
            @if (Auth::user()->utype ==='ADM')
                <ul class="navbar-item theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="{{ route('admin.dashboard')}}">
                            {{-- <img src="{{ asset('asset/logo.png') }}" class="navbar-logo" alt="logo"> --}}
                        </a>
                    </li>
                    <li class="nav-item theme-text">
                        <a href=""class="nav-link"> <img src="{{ asset('asset/logo.png') }}" width="120" height="60" alt="logo"> </a>
                    </li>
                </ul>
                @elseif (Auth::user()->utype ==='MGR')
                    <ul class="navbar-item theme-brand flex-row  text-center">
                        <li class="nav-item theme-logo">
                            <a href="{{ route('mgr.dashboard')}}">
                                <img src="{{ asset('assets/img/90x90.jpg')}}" class="navbar-logo" alt="logo">
                            </a>
                        </li>
                        <li class="nav-item theme-text">
                            <a href="{{ route('mgr.dashboard')}}" class="nav-link"> RMC </a>
                        </li>
                    </ul>
                ...
                @elseif (Auth::user()->utype ==='USR')
                    ...
                    <ul class="navbar-item theme-brand flex-row  text-center">
                        ...
                        <li class="nav-item theme-text">
                            <a href="{{route('user.dashboard')}}" class="nav-link"> RMC </a>
                        </li>
                    </ul>
                @endif
                        ...
                        <div class="">
                            <div class="dropdown-item">
                                <a class="" href="/profile">
                                    ...
                                    </svg> {{ Auth::user()->fname }} {{ Auth::user()->lname }}</a>
                            </div>
                            {{-- <div class="dropdown-item">
                ...
                <li>
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0);">RMC</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><span>Timesheet App</span></li>
                            </ol>
                        </nav>
   ...
   <div class="footer-wrapper">
    <div class="footer-section f-section-1">
        <p class="">Copyright © {{ date('Y') }} <a target="_blank" href="https://hybridsoft.com.ng">Powered By Hybridsoft LTD</a>, All rights reserved.</p>
    </div>
</div>
</div>
<!--  END CONTENT PART  -->
