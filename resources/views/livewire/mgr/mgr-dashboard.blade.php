                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{ asset('assets/img/90x90.jpg')}}" height="40" width="40" alt="avatar">Andy King</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content customer-name"><img src="{{ asset('assets/img/90x90.jpg')}}" height="40" width="40"  alt="avatar">Irene Collins</div></td>
                            ...
                            <div class="widget-content">
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{ asset('assets/img/90x90.jpg')}}" height="40" width="40"  alt="product">Speakers</div></td>
                                            ...
                                            <tr>
                                                <td><div class="td-content product-name"><img src="{{ asset('assets/img/90x90.jpg')}}" height="40" width="40"  alt="product">Sunglasses</div></td>
