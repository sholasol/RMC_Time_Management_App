        ...
        <div class="row scrumboard" id="cancel-row">
            <div class="col-lg-12 layout-spacing">
                ...
                <div class="task-list-section">
                  <div class="row">
                        <div data-section="s-new" class="task-list-container col-md-3" data-connect="sorting">
                        ...
                        <div data-section="s-in-progress" class="task-list-container col-md-3" data-connect="sorting">
                            <div class="connect-sorting">
                                <div class="task-container-header">
                        ...
                        <div data-section="s-approved" class="task-list-container col-md-3" data-connect="sorting">
